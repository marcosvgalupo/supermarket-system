...
try:
    ...
    registradora.fazer_pagamento(total_venda, Operadora.AMERICAN, 1, TipoCalculadora.JUROS_SIMPLES)
    ...
    registradora2.fazer_pagamento(100.00)
    ...
    registradora3.fazer_pagamento(registradora3.get_venda_corrente().calcular_total_venda(), "Banco do Brasil")
